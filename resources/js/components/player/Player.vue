    ...
    <div class="text-white min-h-[100vh] py-8 px-4">
        <div v-if="loaded" class="max-w-6xl mx-auto">
                ...
                <div class="flex flex-col md:flex-row gap-8 items-center md:items-start">
                    ...
                    <div class="flex-grow w-full">
                        ...
                        <div class="grid grid-cols-2 gap-4">
                            <div class="bg-black/30 border border-white/10 p-4 rounded-sm hover:bg-white/5 transition-colors">
            ...
            <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4 mb-6">
                <div class="bg-[#070707] border border-white/30 p-5 rounded-sm hover:bg-white/5 transition-colors text-center">
